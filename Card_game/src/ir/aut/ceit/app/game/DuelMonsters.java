package ir.aut.ceit.app.game;

import ir.aut.ceit.app.applications.*;
...
public class DuelMonsters {
    ...
    private static void printGameState() {
        ...
        System.out.println();
        printCards(spellCardStrings, cpuField.getCards());
